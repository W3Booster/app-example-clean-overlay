...
[Try it now](https://w3booster.github.io/app-example-clean-overlay/) · [Developer docs](https://website.w3booster.com/developer/) · [All examples](https://website.w3booster.com/developer/examples/)
...
The checked-in binding belongs to the official Clean Overlay app. Cloning it does **not** give you ownership or authorize live data. Before launching your own fork, register a new app and replace this binding.
...
Configure stream/in-game URLs as `http://localhost:5173/?view=overlay&demo=0`. The root route is a studio preview; `?view=overlay` is the transparent output. Use W3Booster’s compositor URL in OBS, not a user launch URL.
