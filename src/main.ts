...
const repository = element('a', 'Public repository ↗', 'repository-link'); repository.href = 'https://github.com/W3Booster/app-example-clean-overlay'; repository.target = '_blank'; repository.rel = 'noopener noreferrer';
...
for (const [text, href] of [['Setup guide', 'https://w3booster.com/developer/first-app/'], ['View source', 'https://github.com/W3Booster/app-example-clean-overlay'], ['SDK reference', 'https://w3booster.com/developer/api/']]) {
